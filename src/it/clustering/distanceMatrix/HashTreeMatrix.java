...
public class HashTreeMatrix<C extends Instance & Comparable<C>> implements DistanceMatrix<C>{

	private HashMap<C, TreeMap<C, Double>> data;

	public HashTreeMatrix(List<C> elements) {
		data = new HashMap<C, TreeMap<C, Double>>(
				elements.size());
	...
	/* Returns null if it was not compute */
	@Override
