...
public class SOM implements Clusterer {
    ...
    private class InputVectors extends ArrayList<SomNode> {
        ...
        /**
         * MutualInformationMain constructor for this map. Used to contain all the input vectors.
         */
    ...
    private class WeightVectors extends ArrayList<SomNode> {
        ...
        /**
         * MutualInformationMain constructor. Used to contain the synaptic weight vectors during
         * the learning phase.
         * 
         * @param xDim
    ...
    private class SomNode {
        ...
        /**
         * MutualInformationMain constructor.
         */
        private SomNode() {
            label = "";
            values = new double[1];
        ...
        /**
         * MutualInformationMain constructor (for input vectors).
         * 
         * @param String
        ...
        /**
         * MutualInformationMain constructor (for weight vectors).
         * 
         * @param String
         *            label - Name of this node.
         * @param double[] values - All the values of this node.
